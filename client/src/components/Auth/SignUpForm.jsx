  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-6">
        ...
        <p className="text-white/50 text-sm mt-2">Join us and start your journey</p>
      </div>
      ...
      <div onSubmit={handleSubmit}>
        ...
        <div className="relative group mb-5">
          ...
          <div className="relative">
            ...
            />
            <svg className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-white/40 group-focus-within:text-cyan-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
