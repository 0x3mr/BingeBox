...
function MovieHero() {
  ...
  const handlePlayClick = () => {
    ...
    // Simulate loading time (1.5 seconds) - makes it feel realistic
    setTimeout(() => {
      setIsLoading(false);
    }, 1500);
  };
      ...
      >
        ...
        <div className="inline-flex items-center gap-3 md:gap-5 relative z-1">
          <button
            ...
            className="box-border gap-2 md:gap-2.5 px-5 py-3.5 bg-brand-primary rounded-lg inline-flex items-center cursor-pointer hover:opacity-90 transition-opacity"
          >
          ...
          <div className="flex items-center gap-2">
            <button className="w-12 h-12 rounded-lg bg-black-10 border border-brand-border flex items-center justify-center hover:bg-black-20 transition-colors">
              <svg
                className="w-6 h-6"
                viewBox="0 0 16 16"
