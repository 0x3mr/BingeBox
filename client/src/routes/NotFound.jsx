  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-black text-white font-inter p-4 sm:p-6">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'repeating-linear-gradient(45deg, #0f0f0f 0, #0f0f0f 2px, transparent 2px, transparent 4px), repeating-linear-gradient(-45deg, #0f0f0f 0, #0f0f0f 2px, transparent 2px, transparent 4px)',
      ...
      <div className="relative z-10 w-full max-w-xl bg-gray-900/80 backdrop-blur-xl rounded-3xl overflow-hidden border border-white/10 shadow-[0_0_80px_rgba(255,255,255,0.1)]">
        ...
        <div className="p-10 text-center border-b border-white/10">
          ...
          <h1 className="text-8xl sm:text-[10rem] font-black text-white tracking-tighter leading-none relative">
            4<span className="text-brand-primary/80 transition-all hover:scale-110 inline-block">0</span>4
          </h1>
        </div>
        ...
        <div className="p-8 sm:p-10 text-center">
          ...
          <p className="text-white/70 text-lg mb-10 max-w-sm mx-auto">
            The page you're looking for seems to have been removed from the playlist or never existed. Don't worry, the show must go on!
          </p>
