    ...
    <>
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          ></div>
          <div className="absolute right-0 top-0 h-full w-72 bg-[#0a0a0a] border-l border-white/20 p-4 overflow-auto" role="dialog" aria-modal="true" aria-label="Mobile navigation menu">
            ...
            <nav role="navigation" aria-label="Mobile navigation" className="flex flex-col gap-3">
              <Link
                to="/"
                onClick={() => setIsMobileMenuOpen(false)}
                aria-current={isActive('/') ? 'page' : undefined}
