          ...
          <div className="w-full overflow-x-auto">
            <div className="min-w-[768px] w-full rounded-xl border border-brand-border overflow-hidden">
              ...
              {[
                ...
                { feature: 'Content', basic: 'Access to a wide selection of movies and shows, including some new releases.', standard: 'Access to a wider selection of movies and shows, including most new releases and exclusive content.', premium: 'Access to the widest selection of movies and shows, including all new releases and offline viewing.' },
                { feature: 'Devices', basic: 'Watch on one device', standard: 'Watch on two devices', premium: 'Watch on four devices' },
                ...
                <div key={idx} className={`flex ${idx === 9 ? 'border-t' : 'border-b'} border-brand-border`}>
